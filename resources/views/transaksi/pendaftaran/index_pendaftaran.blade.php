...
<html lang="en">
<head>
  <title>Pendaftaran Pasien - SIP</title>
  <meta charset="utf-8">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            &nbsp&nbsp&nbsp&nbsp <div class="col-1.5">
              <a href="identitas_pasien.html" class="btn btn-sm btn-labeled btn-success mr-2">
            ...
            <div class="col-1.5">
              <a href="index_pendaftaran.html" class="btn btn-sm btn-labeled btn-primary mr-2">
                <span class="btn-label">
              ...
              <div class="card mb-grid">
                <div class="table-responsive-md">
                  <table id="table_id" class="display">
                    <thead>
                      <tr>
                        <th width="10%"class="text-center">KODE REKMED</th>
                        <th width="10%"class="text-center">REKMED LAMA</th>
                        <th width="20%"class="text-center">NAMA</th>
                        <th width="12%"class="text-center">JNS PASIEN</th>
                        <th width="12%"class="text-center">DESA/KEL</th>
                        <th width="9%"class="text-center">ASURANSI/BPJS</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Row 1 Data 2</td>
                        <td>Row 1 Data 3</td>
                        <td class="text-center">Row 1 Data 4</td>
                        <td class="text-center">Row 1 Data 5</td>
                        <td class="text-center">Row 1 Data 6</td>
                        <td>
                         <a href="" class="btn btn-warning btn-sm text-white">Layanan</a>
